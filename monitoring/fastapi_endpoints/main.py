...
if __name__ == "__main__":
    ...
    log_config["formatters"]["access"][
        "fmt"
    ] = log_format #f"%(asctime)s - [Country: {country}, Code: {code}] - %(levelname)s [%(name)s] [%(filename)s:%(lineno)d] [trace_id=%(otelTraceID)s span_id=%(otelSpanID)s resource.service.name=%(otelServiceName)s] - %(message)s"
